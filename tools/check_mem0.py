...
def check_mem0():
    ...
    try:
        ...
        if found:
            ...
            print("⚠️  Warning: Write succeeded but search didn't return the exact fact immediately.")
            print("    (This can happen if the LLM extraction wasn't perfect or indexing is slow)")
